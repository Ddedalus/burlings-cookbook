\begin{recipe}
    ...
    \preparation{%
        ...
        \step  Wrap free edges towards the centre (see the pictures).

        \step Bake for 30-40 min. Once ready, garnish with basil leaves.
    }
...
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{pic/galette}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{pic/galette_2}
\end{figure}